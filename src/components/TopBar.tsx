...
function YouTubeIcon() {
  return (
    <svg className="w-[13px] h-[9px]" fill="#18B3AB" viewBox="0 0 24 24">
...
function TwitterIcon() {
  return (
    <svg className="w-[11px] h-[11px]" fill="#18B3AB" viewBox="0 0 24 24">
...
function ProfileIcon() {
  return (
    <svg className="w-[24px] h-[24px]" fill="#18B3AB" viewBox="0 0 24 24">
...
export default function TopBar() {
  return (
    <div className="bg-white border-b border-gray-100">
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-3">
