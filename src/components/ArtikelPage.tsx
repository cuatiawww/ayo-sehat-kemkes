...
export default function ArtikelPage({ onNavigateHome }: ArtikelPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section - Artikel Ayo Sehat (Teal Background) */}
      <section className="relative bg-gradient-to-b from-[#18b3ab] to-[#15a098] py-12 sm:py-16 lg:py-20 pb-32 sm:pb-40 lg:pb-48 overflow-visible">
        ...
        {/* Floating Image - Overlap between sections */}
        <motion.div
      ...
      {/* Topik yang Banyak Dicari Section (White Background) */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[7fr_3fr] gap-8 lg:gap-12">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              {currentArticles.map((article, index) => (
                ...
                >
                  {/* Card Container with Border - Responsive Layout */}
                    ...
                    <div className="flex flex-col lg:hidden">
                      ...
                      <div className="p-4 sm:p-5 flex flex-col gap-2.5 sm:gap-3">
                        ...
                        <div className="flex gap-2.5 items-center flex-wrap">
                          <p className="font-['Poppins'] text-[11px] sm:text-[12px] leading-[18px] text-[#18b3ab]">
                        ...
                        <div className="font-['Poppins'] text-[16px] sm:text-[18px] leading-[24px] sm:leading-[28px] text-neutral-600">
                          <button className="text-left hover:text-[#18b3ab] hover:underline transition-all duration-200 line-clamp-2">
                            {article.title}
                          </button>
                        </div>

                        {/* Excerpt */}
                        <p className="font-['Poppins'] text-[13px] sm:text-[14px] leading-[22px] sm:leading-[24px] text-neutral-600 line-clamp-2">
                          {article.excerpt}
                        </p>

                        {/* Metadata */}
                        <div className="flex gap-2.5 sm:gap-3 items-center flex-wrap">
                          <p className="font-['Poppins'] text-[11px] sm:text-[12px] leading-[18px] text-[dimgrey]">
                            {article.date}
                          </p>
                    ...
                    <div className="hidden lg:block relative h-[192px]">
                      ...
                      <div className="absolute left-[383px] top-[22px] right-[20px] flex flex-col gap-[8px]">
                        ...
                        <div className="flex gap-[11px] items-center">
                          <p className="font-['Poppins'] text-[12px] leading-[18px] text-[#18b3ab] whitespace-nowrap">
                            {article.lifecycleStage}
                          </p>
                          <div className="w-[4px] h-[4px] rounded-full bg-[#18b3ab] shrink-0" />
                          <p className="font-['Poppins'] text-[12px] leading-[18px] text-[#18b3ab] whitespace-nowrap">
                        ...
                        {/* Title - Semua card sama (no special styling untuk card pertama) */}
                        ...
                        {/* Excerpt */}
                        <p className="font-['Poppins'] text-[14px] sm:text-[16px] lg:text-[18px] leading-[30px] text-neutral-600 line-clamp-1">
                          {article.excerpt}
                        </p>
                        ...
                        <div className="flex gap-[14px] items-center flex-wrap">
                          <div className="flex items-center gap-1">
                            <p className="font-['Poppins'] text-[12px] leading-[18px] text-[dimgrey]">
                              {article.date}
                            </p>
                          </div>
              ...
              <div className="flex items-center justify-center gap-2 pt-8">
                <button
                  ...
                  className="p-2 rounded-lg border border-gray-300 hover:border-[#18b3ab] hover:bg-[#18b3ab]/5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:border-gray-300 disabled:hover:bg-transparent"
                >
                  ...
                  (number) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-['Poppins'] text-[14px] transition-all duration-200 ${
                        currentPage === number
                          ? "bg-[#18b3ab] text-white"
                          : "border border-gray-300 text-gray-700 hover:border-[#18b3ab] hover:bg-[#18b3ab]/5"
                      }`}
                    >
                      {number}
                    </button>
